...
control 'mongodb components' do
  ...
  describe directory('/tmp/mongodb_aaa') do
    it { should exist }
  end
  describe directory('/tmp/mongodb_aaa/mongod-4.2.6') do
    it { should exist }
  end
  ...
  describe file('/opt/mongodb/mongodb-v2.10.0/mongodb') do
    it { should exist }
    its('group') { should eq 'root' }
  end
  describe directory('/var/lib/mongodb/mongodb') do
    it { should exist }
  ...
  describe directory('/usr/local/mongodb/robo3t-1.3.1/libs') do
    it { should exist }
    its('group') { should eq 'root' }
  end
